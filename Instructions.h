...
namespace i8080 {
    ...
    constexpr unsigned int implementInstruction(Cpu& cpu) {
        ...
        // Result 8 Bit
        Byte& resultByte = [&]() constexpr -> Byte& {
        ...
        // Operand 16 Bit
        Word& operandWord = [&]() constexpr -> Word& {
        ...
        // Operand 8 Bit
        Byte& operandByte = [&]() constexpr -> Byte& {
